package FlightTracker.main.java.Application.DAO;
...
public class FlightDAO {
     ...
     * You only need to change the sql String and set preparedStatement parameters.
     *
     * Remember that the format of a select where statement written as a Java String
     * looks something like this:
     * String sql = "select * from TableName where ColumnName = ?";
     * The question marks will be filled in by the preparedStatement setString,
     * setInt, etc methods. they follow
     * this format, where the first argument identifies the question mark to be
     * filled (left to right, starting
    ...
    /**
     * TODO: Add a flight record into the database which matches the values
     * contained in the flight object.
     * You can use the getters already written in the Flight class to retrieve its
     * values (getDeparture_city(),
     * getArrival_city()). The flight_id will be automatically generated by the SQL
     * database, and JDBC will be able
     * to retrieve the generated ID automatically. That means that you when you
     * insert the flight, you only need
     ...
     *
     * @param flight an object modelling a Flight. the flight object does not
     *               contain a flight ID.
     */
    ...
    /**
     * TODO: Update the flight identified by the flight id to the values contained
     * in the flight object.
     *
     * You only need to change the sql String and set preparedStatement parameters.
     *
     * Remember that the format of an update PreparedStatement written as a Java
     * String looks something like this:
     * String sql = "update TableName set ColumnName1=?, ColumnName2=? where
     * ColumnName3 = ?;";
     * The question marks will be filled in by the preparedStatement setString,
     * setInt, etc methods. they follow
     * this format, where the first argument identifies the question mark to be
     ...
     *
     * @param id     a flight ID.
     * @param flight a flight object. the flight object does not contain a flight
     *               ID.
     * @return
     */
